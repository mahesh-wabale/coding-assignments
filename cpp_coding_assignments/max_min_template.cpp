...
T add(T &x ,T &y)                                    // c++ function template
{                                                    //this function accept 2 parameters
        return x+y;                           //and returns minimum of that 2 parameters
}

template <class T>                                   //template syntax

T sub(T &x ,T &y)                                    // c++ function template
{                                                    //this function accept 2 parameters
        return x-y;                           //and returns minimum of that 2 parameters
}
...
int main()
{
          ...
          int i11 = 8,i22 = 2;                         //two integer numbers
          cout << "Addition of two Integers :";
          cout << add(i11,i22) <<endl; 

          double f11 = 8.5,f22 = 2.10;                         //two integer numbers
          cout << "Addition of two Doubles :";
          cout << add(f11,f22) <<endl; 
          
          int i33 = 8,i44 = 2;                         //two integer numbers
          cout << "Subtraction of two Integers :";
          cout << sub(i33,i44) <<endl;                  //template instantiation
