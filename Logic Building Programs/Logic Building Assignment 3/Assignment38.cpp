...
//		and compare both linked list till first N nodes. 
//		Function Prototype :  int ListNCmp( struct node *First struct node *Second int N)
//
////////////////////////////////////////////////////////////////////////////////////////////////
#include<conio.h>
#include<stdio.h>
...
int InsertLast( struct Node **head,  int no )
 ...
 //
 //		Description     :	This function compare two singly linked list upto N nodes.
 //
 //		Returns         :	int => 1 if function succeeds, otherowise return -1.
 //
 /////////////////////////////////////////////////////////////////////////////////////////////
 ...
 int ListNCmp(struct Node *First,struct Node *Second,int N)
 {
	...
	while(temp1!=NULL && temp2!=NULL && N!=0)
	{
 ...
 //
 //		Input 2nd List	:   30 20 10 40 60 55 80 90
 //
 //		Output			:   Both linked list are same upto 4 nodes. 
 //
 //		Input 1st List	:	30 20 10 40 60 50
 //
