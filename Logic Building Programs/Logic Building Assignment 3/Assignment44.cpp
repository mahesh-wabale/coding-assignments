...
//	Function Prototype :  int DeleteFirst(  struct node **Head, struct node **Tail);
//
////////////////////////////////////////////////////////////////////////////////////////
#include<conio.h>
#include<stdio.h>
...
void DisplayList(struct Node *head)
{
 ...
 int main()
 {
	...
	DeleteFirst(&first,&last);
	DeleteFirst(&first,&last);
	//DeleteFirst(&first,&last); //error,segmentation fault because if we delete all node of the list,then it gives error when we tries to display list.
