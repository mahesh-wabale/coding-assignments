////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//	54.Write a program which accept two singly circular linked list from user and concat last N elements 
//	of source linked list after destination linked list. 
//	Function Prototype :  int ConcatLastN(  struct node **SrcHead , struct node **SrcTail,  
...
//
//		Description		:	This function concat last N elements of source list after 
//							destination linked list.
//
//		Returns			:  1 on success otherwise return 0
//
//////////////////////////////////////////////////////////////////////////////////////////////
int ConcatLastN(struct Node **SrcHead,struct Node **SrcTail,struct Node **DestHead,struct Node **DestTail,int no)
{
	struct Node *newnode=NULL;
...
int main()
{
	...
	ConcatLastN(&first1,&last1,&first2,&last2,3);
...
//
//		Output				:	11 22 33 44 55 30 40 50
//////////////////////////////////////////////////////////////////////////////////////////////
